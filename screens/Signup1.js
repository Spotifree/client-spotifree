  ...
  submitHandle() {
    ...
    return (
      ...
      >
        ...
        <TextInput
          style={{ fontSize: 20, paddingHorizontal: 5, height: 50, backgroundColor: this.state.backgroundColor1, borderRadius: 3, marginTop: 3 }}
        ...
        <TextInput
          style={{ fontSize: 20, paddingHorizontal: 5, height: 50, backgroundColor: this.state.backgroundColor2, borderRadius: 3, marginTop: 3 }}
          underlineColorAndroid='transparent'
        ...
        <TextInput
          style={{ fontSize: 20, paddingHorizontal: 5, height: 50, backgroundColor: this.state.backgroundColor3, borderRadius: 3, marginTop: 3 }}
          underlineColorAndroid='transparent'
        ...
        <TouchableOpacity style={ styles.button } onPress={() => this.submitHandle()}>
          <Text style={{ alignSelf: 'center', fontWeight: '800', color: '#FFFFFF' }}>BERIKUTNYA</Text>
        </TouchableOpacity>
			</ScrollView>
      </KeyboardAvoidingView>
		)
